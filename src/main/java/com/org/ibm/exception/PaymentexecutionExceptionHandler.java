...
public class PaymentexecutionExceptionHandler extends ResponseEntityExceptionHandler{
	...
	@Autowired
	private RetrievePaymentMechanismI retrievePaymentMechanismI;
	@Autowired
	private RetrievePaymentExecutionWorkstepI retrievePaymentExecutionWorkstepI;
	...
	private Object getErrorObject(String operationId,ErrorStatusCode code,Exception exception){
		...
		if(apiExceptionResponse != null) {
			...
			case "retrievePaymentMechanism":
			object = retrievePaymentMechanismI.error(code.getCode(),apiExceptionResponse.getDataType(),exception);
			break;
			
			case "retrievePaymentExecutionWorkstep":
			object = retrievePaymentExecutionWorkstepI.error(code.getCode(),apiExceptionResponse.getDataType(),exception);
			break;
